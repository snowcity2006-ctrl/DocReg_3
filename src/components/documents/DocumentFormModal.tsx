            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-0.5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-[#171A21] border border-[#2D3139] rounded-xl text-xs text-[#E0E0E0] focus:outline-none focus:border-blue-500"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative" ref={deptDropdownRef}>
              ...
              <div
                ...
                className={`w-full min-h-[42px] px-3 py-2 bg-[#0F1115] border ${
